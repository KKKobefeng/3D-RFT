...
linearVelocity = 0.4; % linear velocity in m/s
angularVelocity = 0.001; % angular velocity in rad/s
rhoC = 2000; % critical density of the sand in kg/m³   
muInt = 0.275; % internal friction coefficient of the sand
muSurf = 0.35; % intruder-surface interaction coefficient
depth = 0.20; % in m
showGeometry = false;
...
%% Read .stl file
TRG = stlread('./NingningCone/Models/CPTCone.stl'); % possibilities: CylinderFine, Cylinder, CylinderRough, CylinderVeryRough
TRGVisual = stlread('./NingningCone/Models/CPTConeVeryRough.stl');
% Rotate TRG object
